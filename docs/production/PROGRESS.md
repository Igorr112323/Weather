...
- **Проверки:** ruff F,E9 чистый (в orchestrator попутно удалены мёртвые импорты, которые T09 оставил после миграции); профильные наборы test_frost_gdd/test_region_ops/test_market_corn/test_forecast_smoke зелёные; полный suite и CI — ниже.
