...
- **Проверки:** ruff F,E9 чистый; профильные наборы `test_region_api`, `test_readiness`, `test_grid`, `test_pipeline_single`, `test_asof`, `test_ledger` зелёные (57 тестов); полный suite — ниже.
